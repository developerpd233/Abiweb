...
import { mediaData,categoryData } from '../../constant/dropdown/category'
...
export default function SongPlayer({ blur }) {
                    ...
                    <>
                        <Grid lg={2} xs={12} item >
                            <Box className={classes.songDetailBox}>
                                <Typography classsName={classes.songDetail}>Song Title</Typography>
                                <Typography className={classes.songDetail}>Artist</Typography>
                            </Box>

                        </Grid>
                        <Grid item lg={7} xs={12} marginLeft={"-47px"}>
                        ...
                        <Grid item lg={3} xs={12}>
                            ...
                            <Box className={classes.iconsbox} >
                                <Box sx={{ display: 'flex', width: '40%', justifyContent: "flex-start", alignItems: "center" }} onMouseEnter={() => setShowSound(true)} onMouseLeave={() => setShowSound(false)}>
                                    <VolumeUpIcon className={classes.songIcon} />
                                    <Box className={classes.slidersbox} style={{ display: `${showSound ? "block" : "none"}`, marginLeft: '25px', marginRight: '10px', width: '70%' }}>
    ...
    {/* <Grid item lg={2} xs={12}>
                    ...
                    <IconButton color="primary" aria-label="upload picture" component="span" className={classes.iconButton} onClick={handleClickOpen}>
                                <img src={libraryIcon} className={classes.songIcon} />
                            </IconButton>
                            {play ?
                                <>
                                    <IconButton color="primary" aria-label="upload picture" component="span" className={classes.iconButton}>
                    ...
                    <Box sx={{ padding: '70px 55px' }}>
                        <Grid container spacing={2} sx={{ marginBottom: '43px' }}>
                            <Grid item xs={12} sm={12} lg={6} md={6}>
                                <Box sx={{ width: '95%', borderBottom: '2px solid #FF1C51', marginTop: "-12px" }}>
                                            ...
                                            <Box className={classes.topImages}>
                                                {Array.from({ length: 4 }).map((item, index) => (
                                                    <Box className={classes.imagesGrid}>
                                                        <img src={profile} className={classes.img1} />
                                                    </Box>
                                                ))}
                                                <Box>
