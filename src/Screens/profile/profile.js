          ...
          <Grid container spacing={2}>
            <Grid item xs={12} md={3} className={classes.top}>
              ...
              <Box className={classes.followerSection}>
                <Typography className={classes.followersnum}>2,300 </Typography><Typography className={classes.followers}>Supporters</Typography>
                <Typography className={classes.followersnum}>834</Typography><Typography className={classes.followers}> Supporting </Typography>
              </Box>
